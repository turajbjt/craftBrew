...
class SettingsService {
    ...
    public static function initConstants(): void {
        ...
        $defaultMap = [
            ...
            'PNP_BATCH_UPLOAD_URL'    => ['key' => 'pnp_batch_upload_url',    'default' => getenv('PNP_BATCH_UPLOAD_URL') ?: 'https://pay1.plugnpay.com/payment/pnpremote.cgi'],
            'PNP_QUERY_TRANS_URL'     => ['key' => 'pnp_query_trans_url',     'default' => getenv('PNP_QUERY_TRANS_URL') ?: 'https://pay1.plugnpay.com/payment/pnpremote.cgi'],
            'PNP_SMART_SCREENS_URL'   => ['key' => 'pnp_smart_screens_url',   'default' => getenv('PNP_SMART_SCREENS_URL') ?: 'https://pay1.plugnpay.com/pay/'],
